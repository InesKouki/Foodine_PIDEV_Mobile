 ...
 * @author PC
 */
public class ModifierPlanningForm extends Form {

    public ModifierPlanningForm(Resources res, Planning p) {
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((nom.getText().length() == 0)) {
                    ...
                    try {
                        ...
                        p.setDate(formatter.format(datePicker.getDate()));
                        if (new serviceplanning().updatePlan(p)) {
