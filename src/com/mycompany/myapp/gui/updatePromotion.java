 ...
 * @author PC
 */
public class updatePromotion extends Form {

    public updatePromotion(Resources res, Promotion ev) {

        setTitle("Modifier promotion");
        setLayout(BoxLayout.y());
        TextField name = new TextField(String.valueOf(Math.round(ev.getPourcentage() * 100)) , "Pourcentage", 2, TextField.NUMERIC);
            ...
            public void actionPerformed(ActionEvent evt) {
                if ((name.getText().length() == 0 )) {
                    ...
                    try {
                        ...
                        ev.setPourcentage(Double.parseDouble(name.getText()));

                        System.out.println("OBJEEEEECT: " + ev);
                        if (new ServicePromotion().updatePromotion(ev)) {
