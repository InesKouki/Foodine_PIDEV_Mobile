 ...
 * @author Asus
 */
public class AfficherUtilisateurTrierEmail extends SideMenuBaseBackForm{
 Form current;
     public AfficherUtilisateurTrierEmail(Resources res){
       ...
       add(Type);
        ...
        for (User r : ServiceUser.getInstance().getAllUsersTriNom()) {
            add(addItem(r,res));
        }
